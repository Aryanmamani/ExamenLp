...
<html>
    <head>
        ...
        <!--        <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<-->
        <link rel="stylesheet" href="<c:url value='/staticlibs/bootstrap/css/bootstrap.min.css' />">
        <!-- Font Awesome -->
        <link rel="stylesheet" href="<c:url value='/staticlibs/iconos/css/font-awesome.css' />' />">
        <!-- Ionicons -->
        <link rel="stylesheet" href="<c:url value='/staticlibs/iconos/css/ionicons.css' />">
        <!-- Theme style -->
        <link rel="stylesheet" href="<c:url value='/staticlibs/dist/css/AdminLTE.min.css' />">
